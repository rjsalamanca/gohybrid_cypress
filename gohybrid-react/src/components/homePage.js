         ...
         <div>
            <Container role="main" id="carLookUpContainer" style={makeFlex} className="shadow rounded">
               <div id="searchContainer">
                  <h3>Search:</h3>
                  <Form.Control id="selectYear" onChange={(e) => this.handleYear(e)} as="select">
                  ...
                  <Form.Control id="selectMake" onChange={(e) => this.handleMake(e)} as="select">
               ...
               <div id="mainContainer">
                  <div className="searchParameters">
                     <p>Year: <span id="selectedYear">{year}</span></p>
                     <p>Make: <span id="selectedMake">{make}</span></p>
                  </div>
                  {!!this.state.loading ?
